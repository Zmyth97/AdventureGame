...
public class Adventure
{
	...
	public Adventure(AdventureController baseController, AdventurePanel myPanel)
	{
	...
	public String successStory()
	{
		...
		else if (getSuccessResult() == 8 && baseController.optionChosen() == 2)
		{
		...
		else if (getSuccessResult() == 9 && baseController.optionChosen() == 1)
		{
			successStory = "You barely escape! You can hear the bacon left in your tent sizzling with the heat. Yum.";
		}
		else if (getSuccessResult() == 9 && baseController.optionChosen() == 2)
		{
	...
	public String deathStory()
	{
		...
		else if (getDeathResult() == 7 && baseController.optionChosen() == 2)
		{
